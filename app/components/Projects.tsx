...
export default function Projects() {
    return (
        <section className='min-h-screen mt-30 pt-20 lg:pb-80 px-5 md:px-10 lg:px-20 bg-[linear-gradient(135deg,rgba(255,255,255,0.14)_0%,rgba(255,255,255,0.06)_18%,rgba(255,255,255,0)_38%)]'>
            ...
            <section className='flex flex-col md:flex-row flex-wrap gap-10 pt-20'>
