...
export default function SkillCard({ skill, image }: { skill: string, image: StaticImageData }) {
    return (
        <div className='flex flex-col justify-center h-[22vh] w-[40vw] max-w-60 max-h-40 py-2 bg-[#111827cc] backdrop-blur-lg border border-[#ffffff24] rounded-2xl shadow-lg '>
