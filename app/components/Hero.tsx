...
export default function Hero() {
    ...
    return (
        <section className='relative pt-30 pb-20 border-b  flex flex-col items-center justify-center px-5'>
            ...
            <p className='hero-item text-center mb-5 text-[#94a3b8] font-[DMSans] text-[18px] '>I craft modern responsive web apps with clean UI </p>
            <div className='hero-item flex gap-3 justify-between md:w-[45%] max-w-100'>
                <button className='bg-[#4f46e5]  rounded-md md:text-lg md:p-3 text-sm font-[Spectral]  px-4 py-1 cursor-pointer hover:bg-[indigo]'>View My Work</button>
                {/* <button className='bg-[purple] border rounded-md text-[white] px-2 py-1'>Download CV</button> */}
                <button className='bg-[#6366f1]  rounded-md text-[white] md:text-lg md:p-3 font-[Spectral] px-2 py-1 cursor-pointer hover:bg-[indigo]'>Contact Me
                </button>
            </div>
