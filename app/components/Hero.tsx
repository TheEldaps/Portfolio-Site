...
export default function Hero() {
    ...
    return (
        <section id='home' className='relative pt-30 pb-20 min-h-screen  flex flex-col items-center justify-center px-5'>
            ...
            <p className='hero-item text-center mb-5 text-[#94a3b8] font-[DMSans] text-[14px] md:text-[20px] '>I craft modern responsive web apps with clean UI </p>
            <div className='hero-item flex gap-3 justify-between md:w-[45%] max-w-100'>
                <button className='bg-[#4f46e5]  rounded-md md:text-lg md:px-6 md:py-2 text-sm font-[DMSans]  px-4 py-1 cursor-pointer hover:bg-[#4e46e5d4]'><Link href='#projects'>View My Work</Link></button>
