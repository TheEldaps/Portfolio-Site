...
export default function Contact() {
    return (
        <section id='contact-me' className='pt-10 px-5 min-h-screen md:px-10 lg:px-20 lg:pt-20 font-[spectral] bg-[linear-gradient(135deg,rgba(255,255,255,0.14)_0%,rgba(255,255,255,0.06)_18%,rgba(255,255,255,0)_38%)]'>
            ...
            <section className='md:flex gap-10 py-10 mx-auto  '>
                <form action="" className='border py-5 px-5 mb-20 rounded-3xl mx-[5%] bg-[#111827cc]'>
                    ...
                    <div>
                        ...
                        <textarea id='message' cols={40} rows={5} className='border block font-[spectral] px-2 py-1 w-full'></textarea>
                    </div>
                    <button className='bg-[#4f46e5] px-4 py-2 rounded-md block m-auto mt-5 cursor-pointer hover:bg-[#4e46e5af]'>Send Message</button>
                </form>
