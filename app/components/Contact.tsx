...
export default function Contact() {
    return (
        <section id='contact-me' className='pt-10 px-5 min-h-screen md:px-10 lg:px-20 lg:pt-20 font-[spectral] bg-[linear-gradient(135deg,rgba(255,255,255,0.14)_0%,rgba(255,255,255,0.06)_18%,rgba(255,255,255,0)_38%)]'>
            ...
            <section className='md:flex gap-10 py-10 mx-auto  border md:items-center'>
                <form action="" className='border py-5 px-5 mb-20 md:mb-0 rounded-3xl mx-[5%] bg-[#111827cc] md:min-w-[40%] md:h-[500px] '>
                    ...
                    <div>
                        ...
                        <textarea id='message' cols={40} rows={5} className='border block font-[spectral] px-2 py-1 w-full md:h-50'></textarea>
                    </div>
